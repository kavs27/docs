...
2. [Add gateway configs to your Segmind requests](../../product/ai-gateway/configs.md)
3. [Tracing Segmind's requests](../../product/observability/traces.md)
4. [Setup a fallback from OpenAI to Segmind](../../product/ai-gateway/fallbacks.md)
