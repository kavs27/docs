...
2. [Add gateway configs to your MonsterAPI requests](../../product/ai-gateway/configs.md)
3. [Tracing MonsterAPI requests](../../product/observability/traces.md)
4. [Setup a fallback from OpenAI to MonsterAPI APIs](../../product/ai-gateway/fallbacks.md)
