...
{% content-ref url="../../../product/ai-gateway/multimodal-capabilities/speech-to-text.md" %}
[speech-to-text.md](../../../product/ai-gateway/multimodal-capabilities/speech-to-text.md)
{% endcontent-ref %}
