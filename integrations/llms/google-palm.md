...
2. [Add gateway configs to your Palm requests](../../product/ai-gateway/configs.md)
3. [Tracing Google Palm requests](../../product/observability/traces.md)
4. [Setup a fallback from OpenAI to Palm APIs](../../product/ai-gateway/fallbacks.md)
